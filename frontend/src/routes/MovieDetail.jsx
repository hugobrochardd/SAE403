  ...
  return movie ? (
    <section className=''>
      ...
      <div className="absolute inset-0 bg-black/60 flex justify-center items-center ">
        <PlayCircle className='size-20 text-white cursor-pointer z-10' onClick={handleAddToWatchlist}></PlayCircle>
      </div>
        ...
        <div className="flex flex-row p-2 gap-10">
          ...
          <div className="text-white text-sm w-full flex flex-col gap-1 justify-between my-1" onclick="">
              ...
              <div className="flex flex-col gap-0 text-sm">
                  <h2 className="text-white font-light opacity-80">{movie.released} - {movie.category[0].name}</h2>
    ...
    <section className="flex flex-row justify-between px-20 pb-10 w-full pt-[2.125rem] items-center text-white">
