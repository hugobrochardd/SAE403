...
import { fetchRandomMovies } from "../lib/loaders";
...
export default function Top() {
  ...
  return (
    <section className="flex flex-col gap-8 pt-[4.125rem] min-h-screen">
      <section className="w-full flex items-center justify-center py-16 bg-[url('../../public/_assets/top.jpg')] object-cover object-center">
