...
export default function New() {
  ...
  return (
    <section className="flex flex-col gap-8 pt-[4.125rem] min-h-screen">
      <section className="w-full flex items-center justify-center py-16 bg-[url('../../public/_assets/new.jpg')] object-cover object-center">
        <div className="absolute inset-0 bg-neutral-900/60"></div>
        <h1 className="text-3xl font-light text-main-400 pt-3 z-20">Nouveautés</h1>
      </section>
      <div className="flex flex-row justify-between mx-10 mb-5">
          <p className="text-2xl font-light text-neutral-100">Découvrez les derniers films ajoutés</p>
